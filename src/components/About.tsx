      ...
      >
        ...
        <div ref={textRef} className="flex-1">
          ...
          <p className="text-lg leading-relaxed text-black mb-6">
            ...
            refreshing and flavorful experience in every sip.
          </p>

            <p className="text-lg leading-relaxed text-black">
            Whether you&apos;re enjoying it during a busy day, with friends, or at special moments, Best Juice offers the perfect balance of freshness and energy. More than just a drink, it represents vitality, enjoyment, and authentic Egyptian refreshment.
          </p>
        </div>
      </div>
    </div>
